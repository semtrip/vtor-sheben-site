                    ...
                    <div className="inputs">
                    {
                        ...
                        <>
                            <div className={errorName ? 'input error': 'input'} onClick={()=>{handleClick(1)}}>
                                <span>Имя <b>*</b></span>
                                <input type="text" autoComplete="new-password" ref={input} value={name} onChange={event => {setName(event.target.value)}}/>
                            </div>
                            ...
                            <div className="input area"  onClick={()=>{handleClick(3)}}>
                                <span>Сообщение</span>
                                <textarea autoComplete="new-password" cols="30" rows="10" ref={input3} value={message} onChange={event => {setMessage(event.target.value)}}/>
                            </div>
